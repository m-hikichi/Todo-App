...
| FC-02-01-002 | SPEC-001 | FR-009 | cmd/server/api.go, internal/todo/store.go, web/index.html, web/app.js | handleTodos, handleTodoByID, CreateTodo, UpdateTodo, validateTodoValues, applyStoredDateTime, combineDateAndTime, bindTimeFieldPicker, openTimePicker | internal/todo/store_test.go, 手動確認（作成/編集フォームで開始予定日を更新し、開始時刻入力枠クリックでタイムピッカーを開く） | ✅ |
| FC-02-01-001 | SPEC-001 | FR-010 | cmd/server/api.go, internal/todo/store.go, web/index.html, web/app.js | handleTodos, handleTodoByID, CreateTodo, UpdateTodo, validateTodoValues, isValidStartDue, applyStoredDateTime, bindTimeFieldPicker, openTimePicker | internal/todo/store_test.go, 手動確認（作成/編集フォームで締切日を更新し、締切時刻入力枠クリックでタイムピッカーを開く） | ✅ |
